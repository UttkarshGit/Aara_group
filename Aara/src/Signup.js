...
<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-apple" viewBox="0 0 16 16">
  ...
  <input type="text" class="form-control diss" id="exampleFormControlInput1" />
</div>
<div class="mb-3">
  <label  class="form-label">Email</label>
  <input type="email" class="form-control diss" id="exampleFormControlInput1" />
</div>
<div class="mb-3">
